...
% Regle solve/3
% Usage : Trouve la solution d'un cryptogramme
...
% Regle somme/7
% Usage : utilitaire de somme d'element avec prise en compte de la retenue
...
% Regle sommeChiffres/7
% Usage : Regle utilitaire de somme de deux chiffres avec prise en compte de la retenue
